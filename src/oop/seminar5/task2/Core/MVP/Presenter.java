package oop.seminar5.task2.Core.MVP;

import oop.seminar5.task2.Core.Models.Contact;
...
public class Presenter {
    ...
    public void saveToFile() { model.save(); }
    public void saveToFileAnotherFormat() { model.saveAnother(); }
    public void next() {
        if (model.currentBook().count() > 0) {
